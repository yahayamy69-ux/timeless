...
function FounderSection() {
  return (
    <section className="relative min-h-[100vh] bg-[#050505] text-white">
      <div className="relative mx-auto flex min-h-[100vh] max-w-6xl flex-col justify-center gap-16 px-6 py-24 lg:flex-row lg:items-center">
        ...
        >
          ...
          <h2 className="mt-6 text-[4rem] font-serif uppercase tracking-[-0.04em] leading-[0.95] sm:text-[5rem]">
            Born in Maiduguri, curated for a quiet collector.
          </h2>
          <p className="mt-10 max-w-xl text-lg leading-9 text-white/65">
            Emjay guides the collection with calm precision, selecting every watch for long-form elegance, private presentation and timeless assurance.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.4 }}
          transition={{ duration: 1.1, ease: 'easeOut' }}
          className="relative h-[420px] overflow-hidden rounded-none border border-white/10 bg-[#111] lg:h-[560px] lg:w-[520px]"
        >
